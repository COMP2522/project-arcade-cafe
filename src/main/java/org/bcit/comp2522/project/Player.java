...
/**
 * Player class represents the player in the game. It extends the Sprite class
 * and is a Singleton, ensuring only one instance of the Player exists at a time.
 *
...
public class Player extends Sprite{
  ...
  private Player(int x, int y, int s, Window window, int hp, int fr){
    ...
    playerImage.resize(PLAYER_IMAGE_SIZE,PLAYER_IMAGE_SIZE);
  }
